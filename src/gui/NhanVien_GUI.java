...
public class NhanVien_GUI extends JPanel implements ActionListener, MouseListener {
    ...
    public NhanVien_GUI() {
        ...
        txtMaNV.setBorder(BorderFactory.createLineBorder(brown, 3));
        txtTenNV.setBorder(BorderFactory.createLineBorder(brown, 3));
        comboTrangThaiLamViec.setBorder(BorderFactory.createLineBorder(brown, 3));
        txtNgayVaoLam.setBorder(BorderFactory.createLineBorder(brown, 3));
        txtSdt.setBorder(BorderFactory.createLineBorder(brown, 3));
        txtEmail.setBorder(BorderFactory.createLineBorder(brown, 3));
        comboChucVu.setBorder(BorderFactory.createLineBorder(brown, 3));
        ...
        decorateButton(btnThem);
        decorateButton(btnCapNhat);
        decorateButton(btnXoaTrang);
        decorateButton(btnLuong);
        decorateButton(btnTim);
        decorateButton(btnAll);

        boxTop.add(Box.createHorizontalStrut(60));
        boxTop.add(btnThem);
        // boxTop.add(Box.createHorizontalStrut(10));
        // boxTop.add(btnXoa);
        boxTop.add(Box.createHorizontalStrut(20));
