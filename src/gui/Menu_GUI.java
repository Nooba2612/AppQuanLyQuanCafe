...
public class Menu_GUI extends JPanel implements ActionListener, MouseListener {
    ...
    public Menu_GUI() {
        ...
        txtMaMon.setBorder(BorderFactory.createLineBorder(brown, 3));
        txtTenMon.setBorder(BorderFactory.createLineBorder(brown, 3));
        txtGia.setBorder(BorderFactory.createLineBorder(brown, 3));
        combodvt.setBorder(BorderFactory.createLineBorder(brown, 3));
        ...
        JScrollPane scr = new JScrollPane(tableMonNuoc);
